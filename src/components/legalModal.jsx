...
import { ShieldAlert, CheckCircle, X, Scale, FileText, Lock, AlertTriangle, Server, BookOpen, UserCheck } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-3xl w-full max-h-[85vh] flex flex-col border border-slate-200 dark:border-slate-700">
        ...
        <div className="p-6 overflow-y-auto text-slate-600 dark:text-slate-300 space-y-6 text-sm leading-relaxed custom-scrollbar">
          ...
          <section>
            <h3 className="flex items-center gap-2 font-bold text-slate-900 dark:text-white text-base mb-2">
              <UserCheck className="w-4 h-4 text-indigo-500"/> 4. Account Security & Data Protection
            </h3>
            <p>
              We are dedicated to safeguarding your personal information. Your account credentials and registration details are encrypted and stored securely on our servers using industry-standard security protocols. We implement strict access controls to ensure your personal data remains private and is never sold to third parties.
            </p>
          </section>

          <section>
            <h3 className="flex items-center gap-2 font-bold text-slate-900 dark:text-white text-base mb-2">
              <FileText className="w-4 h-4 text-orange-500"/> 5. Indemnification & Limitation of Liability
            </h3>
            <p>
          ...
          <section>
            ...
            <p>
              All code, design, interface elements, and proprietary algorithms contained within ClinicalAssist are the intellectual property of the developers. Unauthorized reproduction, reverse engineering, or redistribution is strictly prohibited.
            </p>
          </section>
